...
//CRIANDO UMA FUNÇÃO SCANNER
	Scanner s1 = new Scanner(System.in);
	
//CRIANDO O MÉTODO LERRETA
	public double lerReta(){
		
			System.out.println("Primeira reta: ");
			System.out.println("Posição do ponto A da Reta");
			System.out.print("X = ");
			reta[0] = s1.nextDouble();
			System.out.print("Y = ");
			reta[1] = s1.nextDouble();
			System.out.println("Posição do ponto B da Reta");
			System.out.print("X = ");
...
//METODO PARA INFORMAR QUAL É O COEFICIENTE ANGULAR DA RETA
	public void coeficienteAngular(){
		coefAng = (reta[3] - reta[1]) / (reta[2] - reta[0]);
		System.out.println("O coeficiente angular da reta é = " + coefAng);
	}
	
//METODO PARA INFORMAR O COEFICIENTE LINEAR DA RETA
	public void coefLinear(){
		coefLin = (coefAng * (reta[2] - reta[3]))*(-1);
		System.out.println("O coeficiente linear da reta é = " + coefLin);
	}
...
//METODO PARA COMPARAR A RETA1 COM A RETA QUE SERÁ DIGITADA POR ESTE METODO
...
//IMPRESSÕES FALANDO SE POSSUI INTERSEÇÃO OU NÃO OU SE AS RETAS SÃO PARALELEAS
		if(z == 1){
			System.out.println("Possui interseção!!");
		...
		if(z == 0){
			System.out.println("As retas não possuem interseção!!");
		}
	}	
}